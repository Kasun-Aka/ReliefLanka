...
function ModuleCard({
  ...
  return (
    <Link
      to={to}
      className={`group relative flex flex-col overflow-hidden rounded-xl border border-line bg-surface p-6 shadow-panel
        transition-all duration-200 hover:-translate-y-1 hover:shadow-raised ${a.border}`}
    >
      {/* icon badge */}
    ...
    <div className="flex flex-col gap-0">
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 xl:grid-cols-3">
        ...
        <div className="flex flex-col gap-5">
          ...
          {/* needs attention now */}
          <section className="rounded-xl border border-line bg-surface shadow-panel" aria-labelledby="urgent-heading">
          ...
          {/* restock first */}
          <section className="rounded-xl border border-line bg-surface shadow-panel" aria-labelledby="restock-heading">
            <div className="flex items-center justify-between border-b border-line px-4 py-3">
              <div className="flex items-center gap-2">
      ...
      {/* ══════════════════════════════════════════════════════
          FOOTER STRIP
      ══════════════════════════════════════════════════════ */}
      <div className="mt-10 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-line bg-surface px-6 py-4 shadow-panel">
